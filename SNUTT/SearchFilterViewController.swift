...
class SearchFilterViewController: UIViewController {
    ...
    @IBOutlet var tagTypeListTableView: UITableView!
    @IBOutlet var tagDetailListTableView: UITableView!

    @IBAction func hide(_: UIButton) {
        delegate?.hide(self)
    }

    @IBAction func applyFilter(_: UIButton) {
