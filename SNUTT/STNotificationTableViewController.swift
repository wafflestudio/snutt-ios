...
class STNotificationTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return STNotificationManager.sharedInstance.notificationList.count
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let notification = STNotificationManager.sharedInstance.notificationList[indexPath.row]
    ...
    override func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        sizingCell.notification = STNotificationManager.sharedInstance.notificationList[indexPath.row]
