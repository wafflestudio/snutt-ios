...
final class ExpandableLectureCell: UICollectionViewCell {
    ...
    private var didTapButtonSubject = PassthroughSubject<ActionButtonType, Never>()
    var didTapButtonPublisher: AnyPublisher<ActionButtonType, Never> {
    ...
    override func hitTest(_ point: CGPoint, with event: UIEvent?) -> UIView? {
        let hasNoAnimation = layer.animationKeys()?.isEmpty ?? true
        isUserInteractionEnabled = hasNoAnimation
