...
struct TimetablePainterThemeTests {
    ...
    func preferredTheme() {
        let lecture1 = Lecture.stub(timetableLectureID: "1", colorIndex: 1)
        let lecture2 = Lecture.stub(timetableLectureID: "2", colorIndex: 5)
    ...
    func customThemeLectureCustomColor() {
        ...
        let lecture = Lecture.stub(timetableLectureID: "1", colorIndex: 2, customColor: customColor)
    ...
    func customThemeFromAvailable() {
        let lecture1 = Lecture.stub(timetableLectureID: "1", colorIndex: 1)
        let lecture2 = Lecture.stub(timetableLectureID: "2", colorIndex: 3)
    ...
    func customThemeNotFoundFallback() {
        let lecture1 = Lecture.stub(timetableLectureID: "1", colorIndex: 1)
        let lecture2 = Lecture.stub(timetableLectureID: "2", colorIndex: 2)
