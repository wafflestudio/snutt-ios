...
class LectureListViewModel: BaseViewModel, ObservableObject {
    ...
    var placeholderLecture: Lecture {
        ...
        lecture.timePlaces.append(.init(id: UUID().uuidString, day: .mon, startTime: .init(hour: 9, minute: 0), endTime: .init(hour: 10, minute: 0), startMinute: 540, endMinute: 600, place: "", isCustom: true, isTemporary: true))
        return lecture
    }
}
